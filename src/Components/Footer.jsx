...
function Footer() {
  return (
    <div className='d-flex justify-content-center align-items-center flex-colum bg-info text-light mt-5' style={{width : "100%" , height:"300px"}}>
      ...
      <div className='footer-content d-flex justify-content-evenly w-100 flex-wrap'>
        <div style={{width:"400px"}} className='website'>
          ...
          <h6>
            Design and build will all the love in the world by Luminar team ith the help of contributors.
          </h6>
          ...
          <div className='d-flex'>
            <input className='form-control' placeholder='Enter your Mail' />
              <button className="btn btn-warning ms-3">
                <i className="fa-solid fa-arrow-rignt fa-beat"></i>
              </button>
            </div>
      ...
      <p>Copyright c 2023 E Cart .Build with React.</p>
    </div>
  )
}
