...
function View() {
  ...
  return (
    <>
      ...
      <div className='container d-flex align-items-center' style={{ marginTop: '150px', height: '70vh' }}>
        <div className="row mtb-5 align-items-center">
          <div className="col-lg-1"></div>
          <div className="col-lg-5">
            <img style={{ height: '400px', width: '400px' }} src={product?.thumbnail} className='img-fluid' alt="" />
          </div>
          <div className="col-lg-1"></div>
          <div className="col-lg-5">
